		...
		<div className="right">
			<div className="right_inner_left">
				<form>
					<div className="status_container">
						<div className="input_container">
							<input type="radio" value="true" id="societe" onChange={toggleIsSociete}
								   name="status" defaultChecked={values.is_societe}/>
					...
					<div className="identifier_container">
						{values.is_societe ?
							<div className="societe_container">
								<div className="input_container">
									<label>Societe:</label>
									<input value={values.societe} maxLength={30} placeholder="EURL . . . . . . "
							...
							<div className="particulier_container">
								<div className="input_container nom">
									<label>Nom:</label>
									<input value={values.nom} maxLength={30} placeholder="Dupont"
										   onChange={set('nom')}/>
								</div>
								<div className="input_container">
									<label>Prenom:</label>
									<input value={values.prenom} maxLength={30} placeholder="Pierre"
										   onChange={set('prenom')}/>
								</div>
							</div>
						}
					...
					<div className="static_container">
						<div className="contact_container">
							<div className="input_container mail">
								...
								<input value={values.email} maxLength={40} type="email"
									   placeholder="pierre.dupont@mail.com" onChange={set('email')}/>
							</div>
							<div className="input_container">
								<label>Télephone:</label>
								<input value={values.phone} maxLength={16} type="tel" placeholder="+33 _ __ __ __ __"
									   onChange={set('phone')}/>
							</div>
						</div>
						<div className="content_container">
							<div className="input_container sujet">
								<label>Sujet:</label>
								<input value={values.sujet} maxLength={30} placeholder="Mise aux normes hôtel"
									   onChange={set('sujet')}/>
							</div>
					...
					<div onClick={() => console.log(values)}>Show console</div>
			...
			<div className="right_inner_right">
				<div className="container">
					...
					<a href={"tel:" + Global.housePhoneNumberWithInd} className="item_container link">
						...
						<div className="text">{Global.housePhoneNumberParsed}</div>
					</a>
